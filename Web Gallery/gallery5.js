...
document.addEventListener("DOMContentLoaded", (e) => {
  ...
  if (image[0]) {
    ...
    image[0].addEventListener("click", () => {
      ...
      modalBody.style.backgroundImage = "url('Images/5.1.jpg')";
  ...
  if (image[1]) {
    ...
    image[1].addEventListener("click", () => {
      ...
      modal.style.display = "block";
       // Set the background image of the modal body
      modalBody.style.backgroundImage = "url('Images/5.2.jpg')";
  ...
  if (image[2]) {
    ...
    image[2].addEventListener("click", () => {
      ...
      modal.style.display = "block";
      // Set the background image of the modal body
      modalBody.style.backgroundImage ="url('Images/5.3.jpg')";
  ...
  if (image[3]) {
    ...
    image[3].addEventListener("click", () => {
      ...
      modal.style.display = "block";
      // Set the background image of the modal body
      modalBody.style.backgroundImage ="url('Images/5.4.jpg')";
